...
readonly folder: supposed to be "read only"
	...
	solve the equation of motion, receive desired trajectory, run your controller, iteratively. visualization is also included.
...
*_trajectory.m: what you need to work with. design the trajectory for quadrotor given the path. 
		Calculate desired state given current state vector and current time. 
		The file trajectory_generator gives a framework just for reference.

Contact TAs with any questions you may have.

wenliang.gao@connect.ust.hk
pliap@connect.ust.hk
