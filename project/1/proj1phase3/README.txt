...
path_from_A_star.m: What you need to work with. The code which pre-processes obstacle into a grid map has been given. 
		    You need to generate path points using A* and feed the points into trajectory_generator.m
